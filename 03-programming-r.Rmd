...
library(PACKAGE_NAME)
```
>>>>>>> ca3dd7a967fe361684623f7bc78b2a60c14d9a0c
...
The table with the rearrangement reveals that the most fuel efficient cars on the highway are Volkswagens. Visualizing data this way can be a helpful aid in decision-making (and saving money :-)  
