...
__Step 2: Write the code for estimation.__ We need to write the code for sampling and then computing an estimate from the samples. Typically we encapsulate such steps in a function that we can use in a call to the function `replicate`. 
...
```{r}
one_sample_percentage <- function() {
...
props <- replicate(n = num_repetitions, one_sample_percentage())
```
