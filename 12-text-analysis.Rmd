...
```{r message=FALSE}
moby_dick <- gutenberg_download(gutenberg_id = 15, mirror = "http://mirrors.xmission.com/gutenberg/")
moby_dick
```
...
```{r message=FALSE}
melville <- gutenberg_download(c(11231, 15, 10712, 1900), mirror = "http://mirrors.xmission.com/gutenberg/")
```
...
```{r message=FALSE}
melville <- gutenberg_download(15, mirror = "http://mirrors.xmission.com/gutenberg/")
```
