...
There is quite a bit of discrepancy between the two. Observe that the histogram above has a very long right tail; the mean is pulled upward by flights with long departure delays. When the distribution is skewed like the one here, the median can be a stronger indicator of central tendency. 
