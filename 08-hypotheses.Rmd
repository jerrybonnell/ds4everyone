...
ggplot(tibble(sample_stats)) +
  ...
  annotate("point", x = observed_heads, y = 0, size = 3, 
             color = "salmon") +
  labs(x = "Number of heads")
```
...
ggplot(tibble(sample_stats)) +
  ...
  annotate("point", x = observed_heads, y = 0, size = 3, color = "red") +
  labs(x = "Number of heads")
```
...
ggplot(tibble(sample_class_tvds)) +
  ...
  annotate("point", x = harvard_diff, y = 0, size = 3, color = "salmon")
```
...
ggplot(tibble(sample_means)) +
  geom_histogram(aes(x = sample_means, y = after_stat(density)), 
                 bins = 15, fill = "darkcyan", color = 'gray') + 
  annotate("point", x = observed_statistic, y = 0, 
             size = 3, color = "salmon")
```
...
This means that 10% of our simulated mean statistics are equal to or less than 63. Put differently, the chance of an average midterm score *lower* than 63 occurring, under the assumption of a TA teaching in good faith, is around 10%. 
...
ggplot(tibble(sample_means)) +
  ...
  geom_vline(xintercept = sorted_samples[length(sorted_samples)*0.05], 
             size = 2, color = "purple") + 
  annotate("point", x = observed_statistic, y = 0, size = 3, color = "red")
```
