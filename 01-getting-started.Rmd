...
Base R ships with a number of off-the-shelf data sets you can play with. One of them is `WorldPhones`, which provides the number of telephones in some large geographical regions of the world in 1951 and 1956-1961.
...
* We then study how to extract *insights* from our data using statistical inferencing techniques. 
