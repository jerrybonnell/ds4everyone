...
```{r}
fit <- lm(data = mlb0, Weight ~ Height)
```
...
summary(fit)
fit <- lm(mpg ~ drat, data = mtcars1)
summary(fit)
fit <- lm(mpg ~ wt, data = mtcars1)
summary(fit)
fit <- lm(mpg ~ qsec, data = mtcars1)
summary(fit)
```


```{r}
fit <- lm(mpg ~., data = mtcars1)
summary(fit)
```
...
```{r}
fit <- lm(mpg ~ mpg_fit, data = mtcars2)
summary(fit)
```
