...
Data that exists in any other arrangement is, consequently, *messy*. A critical aspect in distinguishing between tidy and messy data forms is defining the __observational unit__. This can look different depending on the statistical question being asked. Defining the observational unit is so important because data that is tidy in one application can, in fact, be messy in another.  
...
## Vignette: Tidying Assessments in a Course
...
## Vignette: Exploring the College Scorecard
